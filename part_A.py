...
def std_builtin(x):
    ...
    sd : float
        Standard deviation of the list of numbers.
    """
# Either I'm too stupid to understand or haven't gotten proper education to use the def/functions above.
# Nevertheless, here are my answers and step-wise explanations for each of the 3 methods:
